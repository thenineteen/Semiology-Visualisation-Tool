...
def bootstrap_frequency_matrix(counts_df, n_samples=1000, alpha=0.05):
    """
    ...
    for column in counts_df.columns:
        lower_limits, upper_limits = bootstrap_frequency_array(counts_df[column].values, n_samples, alpha)

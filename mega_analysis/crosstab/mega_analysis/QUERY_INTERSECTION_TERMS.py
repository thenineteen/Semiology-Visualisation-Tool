...
def QUERY_INTERSECTION_TERMS(df, *args):
    ...
    for arg in args:
        ...
        inspect_combined_result = query_inspection.reset_index().merge(
            inspect_combined_result, how="inner").set_index('index')
    ...
    inspect_combined_result = inspect_combined_result.dropna(

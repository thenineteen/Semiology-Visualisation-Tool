...
from preprocessing.word_preprocess import args_for_loop
...
def term_phrase_outcome(
    *term_or_precise_phrase, # ensure term exists in the files e.g. don't use a full word on stemmed texts
    ...
    term_list = args_for_loop(*term_or_precise_phrase)
    for terms in term_list:
        ...
        for txt_file in os.listdir(path_to_folder):
            ...
            findall_term = re.findall(terms, pt_txt)
        ...
        print("this term \"{}\" occurs in {} out of {} of the files (total of {} occurances)".format(terms, total_number_occurances, no_file, freq_in_all_files))
        ...
        print("\nfreq analysis: {} in Gold vs {} in non Gold\n\n\n".format(no_Gold, no_No_Surgery+no_Resections))
